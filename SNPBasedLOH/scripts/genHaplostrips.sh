...
ps="${snakemake_wildcards[pars]}"

#run haplostrips
haplostrips -v ../fixDiffVCF/$chr\FixDiff_GQ$gq\_DP$dp\_$ps.vcf.gz -i $chr\:1-$chrL -P ../../data/haplostripsPops.tsv -o haplostrips_$chr\_GQ$gq\_DP$dp\_$ps -p plat,pmex,pfor -S 3 -C '#51127c','#fc8961','#b73779'