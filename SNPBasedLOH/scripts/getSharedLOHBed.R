...
#save shared regions
LOHRegionsSharedLong <- LOHRegionsShared[which(LOHRegionsShared$intSize >= 1000),]

write.table(LOHRegionsSharedLong,
            "ooutput/LOHRegionsSharedCombined/LOHRegionsSharedCombined.bed",
...
write.table(LOHRegionsSharedLong,
            "output/LOHRegionsSharedCombined/LOHAncSharedCombined.bed",
            quote=FALSE, sep='\t',row.names=F,col.names = F)
