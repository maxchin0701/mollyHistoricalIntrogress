...
#SBATCH -o scriptOuts/runSFSStatsSimNonExon
...
for i in {1..1000}; do
	...
	BED=output/LOHRegionsSharedSim/simLOHSharedNonExon_${i}Sorted.bed
	OUT=output/selectionStats/simStatsOut/simRegionsStatsNonExon_${i}.tsv
